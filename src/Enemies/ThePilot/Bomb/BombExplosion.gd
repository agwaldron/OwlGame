...
func createShockwaves():
	...
	leftShockwave.global_position.x -= leftShockwave.spriteHorizontalOffset
	leftShockwave.global_position.y -= leftShockwave.spriteVerticalOffset
	...
	rightShockwave.global_position.x += rightShockwave.spriteHorizontalOffset
	rightShockwave.global_position.y -= rightShockwave.spriteVerticalOffset
